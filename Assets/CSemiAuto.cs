...
public class CSemiAuto : MonoBehaviour
{
    ...
    void Start()
    {
        //Initialization stuff, wow, very cool
    ...
    void Update()
    {
        ...
        ammoText.SetText(ammo + "/" + maxAmmo); //Consistently update the ammo counter
    }
    IEnumerator Reload()
    {
        if (ammo == 0)
